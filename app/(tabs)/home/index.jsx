...
import { ModalTitle, ModalContent,ModalPortal } from 'react-native-modals'
...
const index = () => {
  ...
  const addTodo = async () => {
    try {
      ...
      axios
        .post(
          'http://192.168.194.69:3000/todos/65912a7e7299aba43e0f6d38',
          todoData
        )
        .then(response => {
  ...
  const getUserTodos = async () => {
    try {
      const response = await axios.get(
        `http://192.168.194.69:3000/users/65912a7e7299aba43e0f6d38/todos`
      )
  ...
  const markTodoAsCompleted = async todoId => {
    try {
      ...
      const response = await axios.patch(
        `http://192.168.194.69:3000/todos/${todoId}/complete`
      )
